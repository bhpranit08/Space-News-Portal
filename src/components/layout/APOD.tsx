import { Calendar, User, Copyright, ExternalLink, AlertTriangle } from 'lucide-react';
...
const APOD = () => {
    const { apod, get_apod, error } = get_specific_apod();
                ...
                <div className="max-w-6xl mx-auto w-full">
                    ...
                    {error && (
                        <Alert variant="destructive" className="mt-6">
                            ...
                            <AlertDescription>
                                There is no Astronomy Picture of the Day for this date. Please try a different date.
                            </AlertDescription>
                        </Alert>
                    )}
                </div>
